...
import { MdAddShoppingCart, MdAttachMoney, MdCloudUpload, MdDelete } from 'react-icons/md'
import Loader from './Loader'
import { deleteObject, getDownloadURL, ref, uploadBytesResumable } from "firebase/storage";
import { storage } from "../firebase.config"
import { getAllFashionItems, saveItem } from "../utils/firebaseFunction"
...
const CreateContainer = () => {
  ...
  const [{ fashionItem }, dispatch] = useStateValue();
    ...
    <div className='w-full min-h-screen flex item-center justify-center'>
      <div className='w-[90%] md:w-[75%] border border-gray-300 rounded-lg p-4 flex flex-col items-center justify-center gap-4'>
        ...
        <div className="w-full py-2 border-b border-gray-300 flex items-center gap-2">
          <MdAddShoppingCart className="text-xl text-gray-700" />
          <input
            type="text"
            required
            value={title}
